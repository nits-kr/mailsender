...
<html>
<head>
<title>Complain Upload Portal</title>
...
function insert()
{
    ...
    var textarea = document.getElementById("complain_id").value;
    if(textarea == '')
    {
    ...
    $.ajax({
          type: 'post',
          url: 'complain_update_action.php',
          data: "ids="+textarea,
...
<body>
<center>
    <h2>Complain Upload Portal</h2>
    <hr>
    <textarea name='complain_id' id='complain_id'></textarea><br><br>
