...
$limit = $c;
											...
											$cmd="php /var/www/html/php_file_auto/maild_mumara_open.php $iid $toemails $linen >> /var/www/html/php_file_auto/out/$ip_pair &";
											$res=exec($cmd);
											//echo "$res\n";
											 ...
											 if($emails!='')
					 {
											...
											$cmd="php /var/www/html/php_file_auto/maild_mumara_open.php $iid $toemails $smtpip >> /var/www/html/php_file_auto/out/$ip_pair &";
											$res=exec($cmd);
											//echo "$res\n";
											 } 
											 }
