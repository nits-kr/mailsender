...
$link = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."?c=".$last_entry;
echo "<b>Link : </b>".$link;

########################### Functions ##############################
function createJsonArray() {
    global $from_email, $sub, $ofrom, $message_html, $charen, $contend, $type, $message_plain, $msgid, $mailing_ip, $send_limit, $headers, $sencode, $fmencode, $mode, $datafile, $total_limit, $send_limit, $emailtest, $offerIdenc, $domainenc, $total_limit, $send_limit, $sleep, $wait, $inbox_percentage, $test_after;
    $j_array = array();
    ...
    $j_array['domainenc'] = $domainenc;
    $j_array['sleep'] = $sleep;
    $j_array['wait'] = $wait;
    $j_array['inbox_percentage'] = $inbox_percentage;
    $j_array['test_after'] = $test_after;
