...
$datafile_count=explode("\n",trim(file_get_contents($datafile)));
if(count($datafile_count) == 1) {
        if($datafile[0] == "") {
                ...
                foreach($u as $line)
                        {
                                ...
                                $cmd="php /var/www/html/interface_new/maild_man_lu_new.php '$iid' '$toemails' '$line'";
                                $result = exec($cmd);
                                echo $result."<br>";
                        }
                echo "done";  
