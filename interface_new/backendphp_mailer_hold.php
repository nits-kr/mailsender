                ...
                foreach($u as $line)
                        {
                                ...
                                $cmd="php /var/www/html/interface_new/backendmaild_man_lu.php $iid $toemails $line";
                                $result = exec($cmd);
                                echo $result."<br>";
                        }
                echo "done";  
...
elseif($mode == "bulk")// Bulk mailing 
{
    switch ($sen_t) 
    {
        ...
        mysql_query("update svml_sendgrid set in_link='$furl' where sno='$iid'");
                        ...
                        $cmd="php /var/www/html/interface_new/backendmaild_man_lu.php '$iid' '$toemails' '$linen' >> /var/www/html/interface_new/out/".$ip_pair."_".$d." &";
                        exec($cmd);
                        }
                        sort($u);
                        ...
                        {
                        $toemails=base64_encode($emailtest);
                        $cmd="php /var/www/html/interface_new/backendmaild_man_lu.php $iid $toemails $smtpip  >> /var/www/html/interface_new/out/".$ip_pair."_".$d." &";
