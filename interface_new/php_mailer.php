...
mysql_query("update svml_sendgrid set in_link='$furl' where sno='$iid'");
                                   ...
                                   $tto=array();
										   ...
										   $linen=$u[$i];
											...
											$cmd="php /var/www/html/interface_new/maild_man_lu.php '$iid' '$toemails' '$linen' >> /var/www/html/interface_new/out/$ip_pair &";	
											exec($cmd);
											}
											sort($u);
											...
											{
											$toemails=base64_encode($emailtest);
											$cmd="php /var/www/html/interface_new/maild_man_lu.php $iid $toemails $smtpip  >> /var/www/html/interface_new/out/$ip_pair &";
											exec($cmd);
											 } 
											 	}
