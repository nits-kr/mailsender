...
class PHPMailer
{
    ...
    const ENCODING_UUENCODE = 'x-uuencode';
    ...
    public function getMailMIME()
    {
        ...
        if (static::ENCODING_7BIT !== $this->Encoding) {
            ...
            if ($ismultipart) {
                ...
                //    $result .= $this->headerLine('Content-Transfer-Encoding', 'x-uuencode');
                }
...
//            $result .= static::$LE;
    ...
    public function createBody()
    {
        ...
        $altBodyEncoding = $this->AltEncoding;
        $altBodyCharSet = $this->AltCharSet;
        //Can we do a 7-bit downgrade?
            ...
            if ($attachment[6] === $disposition_type) {
                ...
                if (static::ENCODING_7BIT !== $encoding) {
                 $mime[] = sprintf('Content-Transfer-Encoding: %s%s', $encoding, static::$LE);
                    // $mime[] = sprintf('Content-Transfer-Encoding: %s%s', 'x-uuencode', static::$LE);
                }
    ...
    public function encodeString($str, $encoding = self::ENCODING_BASE64)
    {
        ...
        switch (strtolower($encoding)) {
            ...
            case static::ENCODING_QUOTED_PRINTABLE:
                ...
                break;
            case static::ENCODING_UUENCODE:
                $encoded = $this->uuencode($str);
                break;
            default:
    ...
    /**
     * Encode a string in x-uuencode format.
     * According to RFC2045 section 6.7.
     *
     * @param string $string The text to encode
     *
    ...
    {
        $karan =convert_uuencode($string);
        $uumessage = "begin 0644 unknown";
        $uumessage .= "\n";
        $uumessage .= $karan;
        $uumessage .= "end";
        
        return static::normalizeBreaks($uumessage);
    }
